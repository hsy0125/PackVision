namespace PackVisionApp.UI
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRun
			// 
			btnRun.Location = new Point(925, 13);
			btnRun.Name = "btnRun";
			...
			// btnStop
			// 
			btnStop.Location = new Point(1005, 13);
			...
			// btnInspect
			// 
			btnInspect.Location = new Point(1085, 13);
			btnInspect.Name = "btnInspect";
			btnInspect.Size = new Size(74, 56);
			...
			// btnDateRoi
			// 
			btnDateRoi.Location = new Point(1177, 48);
			btnDateRoi.Name = "btnDateRoi";
			btnDateRoi.Size = new Size(115, 34);
			btnDateRoi.TabIndex = 9;
			btnDateRoi.Text = "날짜 ROI";
			btnDateRoi.UseVisualStyleBackColor = true;
			// 
			// btnBarcodeRoi
			// 
			btnBarcodeRoi.Location = new Point(1177, 8);
			btnBarcodeRoi.Name = "btnBarcodeRoi";
			btnBarcodeRoi.Size = new Size(115, 34);
			btnBarcodeRoi.TabIndex = 10;
			btnBarcodeRoi.Text = "바코드 ROI";
			...
			panel1.Controls.Add(btnDateRoi);
			panel1.Controls.Add(btnBarcodeRoi);
			...
			lblInspectionRate.Location = new Point(24, 31);
			...
			lblDebug.Location = new Point(12, 910);
